...
def log_integration_request(status, url, headers, data, response, error=""):
    ...
    integration_request = frappe.get_doc({
        ...
        "method": "POST",
        "integration_request_service": "Check Tax Payer Type",
...
def taxpayer_status(doc, event):
    ...
    data_to_post = {
        "tin": doc.custom_tin,
        "commodityCategorycode":doc.custom_commodity_category_code
    }
